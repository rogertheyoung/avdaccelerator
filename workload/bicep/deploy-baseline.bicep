...
var varMonitoringRgName = avdUseCustomNaming ? avdMonitoringRgCustomName         : 'rg-avd-${varComputeStorageResourcesNamingStandard}-monitoring' // max length limit 90 characters
